...
Status: in build — issues [#2–#8](https://github.com/Robert-Lark/project-matrix/issues); #2 landed 2026-07-09; #3 + #4 code-complete same day (deploy leg gated on Cloudflare secrets — Rob task, see workers/README.md runbook); #5 (chrome + measurement) next
