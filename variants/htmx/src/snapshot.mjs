...
// tool-derived, never typed (the slice-B/D precedent). Unlike qwik, no turbo
// input declaration is needed: wrangler bundles this module at dev/deploy
// time, outside the turbo build's cache — nothing cached embeds these files.
//
...
// framework-neutral like render.mjs.
